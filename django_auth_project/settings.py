"""
Django settings for django_auth_project.
...
# Option 1: Keep DEBUG on (recommended during development)
DEBUG = True

# Option 2: Or if you want DEBUG off, set ALLOWED_HOSTS
# DEBUG = False
...
# Add a STATICFILES_DIRS entry to tell Django where to find your static files
STATICFILES_DIRS = [
    BASE_DIR / "static",
]
...
FIREBASE_CONFIG = {
    'SERVICE_ACCOUNT_KEY_PATH': os.path.join(BASE_DIR, 'firebase_credentials', 'serviceAccountKey.json'),
}
